...
class plBasicDetailForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        recent_applications = personalbasicdetail.objects.filter(
            pan_num=pan_num,
...
class PersonalDetailForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = '__all__'
        exclude = ['basicdetailform','dsaref_code','franrefCode','application_loan_type','name','empref_code','application_id']
        widgets = {
...
class HomeBasicDetailForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        three_months_ago = timezone.now() - timedelta(days=90)
        recent_applications = homebasicdetail.objects.filter(
            pan_num=pan_num,
            created_at__gte=three_months_ago
        ).order_by('-created_at')
...
class CustomerProfileForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = '__all__'
        exclude = ['basicdetailhome','mobile_number','dsaref_code','franrefCode','application_loan_type','name','empref_code','application_id']
