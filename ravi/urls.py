...
urlpatterns = [
  ...
  # Home basic detail
   ...
   # bhanu
    ...
    path('getByRefCode/<str:refCode>',PlViewSet.as_view({"get":"getByRefCode"}),name="get-homeref-code"),
    path('getApprovedRecords/<str:refCode>',PlViewSet.as_view({"get":"getApprovedRecords"}),name="get-HomeApprovedRecords"),
    path('getRejectedRecords/<str:refCode>',PlViewSet.as_view({"get":"getRejectedRecords"}),name="homegetRejectedRecords"),
# bhanu
